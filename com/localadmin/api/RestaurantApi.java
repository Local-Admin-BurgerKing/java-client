...
public class RestaurantApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addRestaurantCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call addRestaurantValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = addRestaurantCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void addRestaurant() throws ApiException {
        addRestaurantWithHttpInfo();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> addRestaurantWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = addRestaurantValidateBeforeCall(null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call addRestaurantAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addRestaurantValidateBeforeCall(progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @param number number of the restaurant (required)
     * @param body The columns that have to be added (optional)
     * @return Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1 editRestaurant(Integer number, Restaurantoptional body) throws ApiException {
        ApiResponse<Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1> resp = editRestaurantWithHttpInfo(number, body);
        return resp.getData();
    }
     ...
     * @param number number of the restaurant (required)
     * @param body The columns that have to be added (optional)
     * @return ApiResponse&lt;Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1> editRestaurantWithHttpInfo(Integer number, Restaurantoptional body) throws ApiException {
        com.squareup.okhttp.Call call = editRestaurantValidateBeforeCall(number, body, null, null);
        Type localVarReturnType = new TypeToken<Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1>(){}.getType();
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call editRestaurantAsync(Integer number, Restaurantoptional body, final ApiCallback<Paths1restaurantsgetresponses200contentapplication1jsonschemaitemsoneOf1> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceRestaurantCall(Integer number, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call replaceRestaurantValidateBeforeCall(Integer number, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'number' is set
        if (number == null) {
            throw new ApiException("Missing the required parameter 'number' when calling replaceRestaurant(Async)");
        }
        
        com.squareup.okhttp.Call call = replaceRestaurantCall(number, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void replaceRestaurant(Integer number) throws ApiException {
        replaceRestaurantWithHttpInfo(number);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> replaceRestaurantWithHttpInfo(Integer number) throws ApiException {
        com.squareup.okhttp.Call call = replaceRestaurantValidateBeforeCall(number, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call replaceRestaurantAsync(Integer number, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = replaceRestaurantValidateBeforeCall(number, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
