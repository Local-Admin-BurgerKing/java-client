...
public class UserApi {
     ...
     */
    public com.squareup.okhttp.Call addUserCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call addUserValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = addUserCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> addUserWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = addUserValidateBeforeCall(null, null);
     ...
     */
    public com.squareup.okhttp.Call addUserAsync(final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addUserValidateBeforeCall(progressListener, progressRequestListener);
     ...
     * @param mail mail of the user (required)
     * @return Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1 getUser(String mail) throws ApiException {
        ApiResponse<Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1> resp = getUserWithHttpInfo(mail);
        return resp.getData();
    }
     ...
     * Gets user by delivered name
     * @param mail mail of the user (required)
     * @return ApiResponse&lt;Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1> getUserWithHttpInfo(String mail) throws ApiException {
        com.squareup.okhttp.Call call = getUserValidateBeforeCall(mail, null, null);
        Type localVarReturnType = new TypeToken<Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getUserAsync(String mail, final ApiCallback<Paths1usersgetresponses200contentapplication1jsonschemaitemsoneOf1> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceUserCall(String mail, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call replaceUserValidateBeforeCall(String mail, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'mail' is set
        if (mail == null) {
            throw new ApiException("Missing the required parameter 'mail' when calling replaceUser(Async)");
        }
        
        com.squareup.okhttp.Call call = replaceUserCall(mail, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void replaceUser(String mail) throws ApiException {
        replaceUserWithHttpInfo(mail);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> replaceUserWithHttpInfo(String mail) throws ApiException {
        com.squareup.okhttp.Call call = replaceUserValidateBeforeCall(mail, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call replaceUserAsync(String mail, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = replaceUserValidateBeforeCall(mail, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
