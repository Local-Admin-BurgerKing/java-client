...
public class PermissionsApi {
     ...
     * @return List&lt;Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems> getAllPermissions() throws ApiException {
        ApiResponse<List<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems>> resp = getAllPermissionsWithHttpInfo();
        return resp.getData();
    }
     ...
     * Get all permissions
     * Get all available permissions
     * @return ApiResponse&lt;List&lt;Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems>> getAllPermissionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getAllPermissionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems>>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getAllPermissionsAsync(final ApiCallback<List<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems>> callback) throws ApiException {
     ...
     * @param name Name of a valid permission (required)
     * @return Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems getPermission(String name) throws ApiException {
        ApiResponse<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems> resp = getPermissionWithHttpInfo(name);
        return resp.getData();
    }
     ...
     * Get information about a specific permission (name and description)
     * @param name Name of a valid permission (required)
     * @return ApiResponse&lt;Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems> getPermissionWithHttpInfo(String name) throws ApiException {
        com.squareup.okhttp.Call call = getPermissionValidateBeforeCall(name, null, null);
        Type localVarReturnType = new TypeToken<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getPermissionAsync(String name, final ApiCallback<Paths1group17Bname7D1permissionsgetresponses200contentapplication1jsonschemaitems> callback) throws ApiException {
