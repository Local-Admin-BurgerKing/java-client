...
public class User2 implements Serializable{
  ...
  **/
  ...
  public User2 password(String password) {
   ...
   * @return password
  **/
  @Schema(required = true, description = "password for the user account")
  ...
  public User2 group(String group) {
    this.group = group;
    return this;
  }
   ...
   * @return group
  **/
  @Schema(required = true, description = "Name of the group the user is in")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    User2 user2 = (User2) o;
    return Objects.equals(this.name, user2.name) &&
        Objects.equals(this.email, user2.email) &&
        Objects.equals(this.password, user2.password) &&
        Objects.equals(this.group, user2.group);
  }
