...
import io.swagger.client.model.DataEntry;
import io.swagger.client.model.ErrorResponse;
import io.swagger.client.model.Filter2;
import io.swagger.client.model.FilterWrapper;
import io.swagger.client.model.FilterWrapper1;
import org.threeten.bp.LocalDate;
import io.swagger.client.model.Report;
import io.swagger.client.model.Report1;
import io.swagger.client.model.ReportWithReference;
...
public class TablesApi {
     ...
     * @param body Representation of a data entry, consisting of a date and single column values (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call addDailyReportCall(Integer restaurant, Report body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call addDailyReportValidateBeforeCall(Integer restaurant, Report body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addDailyReportCall(restaurant, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void addDailyReport(Integer restaurant, Report body) throws ApiException {
        addDailyReportWithHttpInfo(restaurant, body);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> addDailyReportWithHttpInfo(Integer restaurant, Report body) throws ApiException {
        com.squareup.okhttp.Call call = addDailyReportValidateBeforeCall(restaurant, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call addDailyReportAsync(Integer restaurant, Report body, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = addDailyReportValidateBeforeCall(restaurant, body, progressListener, progressRequestListener);
     ...
     * @param body The filter can only be a column filter (time filter wouldnt make sense) (optional)
     * @param wholeData if true you will get all the data instead of only reference names (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getDateReportsCall(LocalDate date, Filter2 body, Boolean wholeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getDateReportsValidateBeforeCall(LocalDate date, Filter2 body, Boolean wholeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'date' is set
        if (date == null) {
            throw new ApiException("Missing the required parameter 'date' when calling getDateReports(Async)");
        }
        
        com.squareup.okhttp.Call call = getDateReportsCall(date, body, wholeData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ReportWithReference> getDateReports(LocalDate date, Filter2 body, Boolean wholeData) throws ApiException {
        ApiResponse<List<ReportWithReference>> resp = getDateReportsWithHttpInfo(date, body, wholeData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ReportWithReference>> getDateReportsWithHttpInfo(LocalDate date, Filter2 body, Boolean wholeData) throws ApiException {
        com.squareup.okhttp.Call call = getDateReportsValidateBeforeCall(date, body, wholeData, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getDateReportsAsync(LocalDate date, Filter2 body, Boolean wholeData, final ApiCallback<List<ReportWithReference>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getDateReportsValidateBeforeCall(date, body, wholeData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ReportWithReference>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DataEntry getRestaurantDateColumn(Integer restaurant, LocalDate date, String column) throws ApiException {
        ApiResponse<DataEntry> resp = getRestaurantDateColumnWithHttpInfo(restaurant, date, column);
        return resp.getData();
    }
     ...
     * @param date Date in the format 12.12.2001 (required)
     * @param column Name of column, which exists in the given report (required)
     * @return ApiResponse&lt;DataEntry&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DataEntry> getRestaurantDateColumnWithHttpInfo(Integer restaurant, LocalDate date, String column) throws ApiException {
        com.squareup.okhttp.Call call = getRestaurantDateColumnValidateBeforeCall(restaurant, date, column, null, null);
        Type localVarReturnType = new TypeToken<DataEntry>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRestaurantDateColumnAsync(Integer restaurant, LocalDate date, String column, final ApiCallback<DataEntry> callback) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Report1 getRestaurantDateReport(Integer restaurant, LocalDate date) throws ApiException {
        ApiResponse<Report1> resp = getRestaurantDateReportWithHttpInfo(restaurant, date);
        return resp.getData();
    }
     ...
     * @param restaurant ID of a restaurant (required)
     * @param date Date in the format (12.12.2001) (required)
     * @return ApiResponse&lt;Report1&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Report1> getRestaurantDateReportWithHttpInfo(Integer restaurant, LocalDate date) throws ApiException {
        com.squareup.okhttp.Call call = getRestaurantDateReportValidateBeforeCall(restaurant, date, null, null);
        Type localVarReturnType = new TypeToken<Report1>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRestaurantDateReportAsync(Integer restaurant, LocalDate date, final ApiCallback<Report1> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getRestaurantReportsCall(Integer restaurant, FilterWrapper1 body, Boolean wholeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getRestaurantReportsValidateBeforeCall(Integer restaurant, FilterWrapper1 body, Boolean wholeData, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'restaurant' is set
        if (restaurant == null) {
            throw new ApiException("Missing the required parameter 'restaurant' when calling getRestaurantReports(Async)");
        }
        
        com.squareup.okhttp.Call call = getRestaurantReportsCall(restaurant, body, wholeData, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Object> getRestaurantReports(Integer restaurant, FilterWrapper1 body, Boolean wholeData) throws ApiException {
        ApiResponse<List<Object>> resp = getRestaurantReportsWithHttpInfo(restaurant, body, wholeData);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Object>> getRestaurantReportsWithHttpInfo(Integer restaurant, FilterWrapper1 body, Boolean wholeData) throws ApiException {
        com.squareup.okhttp.Call call = getRestaurantReportsValidateBeforeCall(restaurant, body, wholeData, null, null);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getRestaurantReportsAsync(Integer restaurant, FilterWrapper1 body, Boolean wholeData, final ApiCallback<List<Object>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getRestaurantReportsValidateBeforeCall(restaurant, body, wholeData, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Object>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call replaceDailyReportCall(Integer restaurant, LocalDate date, List<DataEntry> body, Boolean _return, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call replaceDailyReportValidateBeforeCall(Integer restaurant, LocalDate date, List<DataEntry> body, Boolean _return, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'restaurant' is set
        if (restaurant == null) {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<DataEntry> replaceDailyReport(Integer restaurant, LocalDate date, List<DataEntry> body, Boolean _return) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<DataEntry>> replaceDailyReportWithHttpInfo(Integer restaurant, LocalDate date, List<DataEntry> body, Boolean _return) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call replaceDailyReportAsync(Integer restaurant, LocalDate date, List<DataEntry> body, Boolean _return, final ApiCallback<List<DataEntry>> callback) throws ApiException {
